...
const AddJobApplicantModal: React.FC<IProps> = ({ formik, handleCloseModal, isOpen }) => {
   return (
      <Dialog open={isOpen} onOpenChange={handleCloseModal}>
         <DialogContent className="max-h-[80vh] overflow-y-auto scroll-none sm:max-w-[80vw] lg:max-w-[70vw] [&>button:hover]:cursor-pointer">
            <DialogHeader>
               ...
               <DialogDescription>
                  Fill the form to add a new Job Applicant.
               </DialogDescription>
            </DialogHeader>
            <JobApplicantForm formik={formik} />
         </DialogContent>
      </Dialog>
   )
}

export default AddJobApplicantModal