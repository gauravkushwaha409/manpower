      ...
      <div className='h-full w-full px-5 py-6 bg-surface rounded-lg'>
         ...
         <div className='flex items-center justify-start'>
            <div className='flex justify-start gap-4'>
               <img
                  ...
                  src={arrowBackIcon}
                  alt="" />
               <span className='typography-heading-poppins-medium text-Black-700'>Job Interview Details</span>
            </div>
         </div>
         ...
         <div className='mt-10 px-2 flex flex-col gap-2'>
            ...
            <div className='flex items-center gap-3.5'>
               ...
               <span className='typography-caption-c1 px-2.5 py-1 bg-yellow/30 rounded-lg'>Scheduled</span>
            </div>
         ...
         <div className='mt-5'>
            <div className='px-6 pt-6 pb-12 mt-8 bg-white rounded-lg'>
               <p className='typography-p2-semibold text-text-color'>Basic Details For Job Interview</p>
               ...
               <div className='mt-6 w-full flex flex-col justify-center gap-5'>
                  ...
                  {/* Date And Time */}
                  <div className='flex items-center gap-8'>
                     <p className='w-1/4 typography-p2-regular text-Black-300'>Date and Time</p>
                     <p className='w-3/4 typography-p2-regular text-Black-300'>2024/01/01 at 6:00 A.M</p>
                  </div>

                  {/* Interviewer Name */}
                  <div className='flex items-center gap-8'>
                     <p className='w-1/4 typography-p2-regular text-Black-300'>Interviewer Name</p>
                     <p className='w-3/4 typography-p2-regular text-Black-300'>Gaurav Kushwaha</p>
                  </div>

                  {/* Salary Offered */}
                  <div className='flex items-center gap-8'>
                     <p className='w-1/4 typography-p2-regular text-Black-300'>Salary Offered</p>
                     <p className='w-3/4 typography-p2-regular text-Black-300'>Rs.10000 per month</p>
                  </div>
