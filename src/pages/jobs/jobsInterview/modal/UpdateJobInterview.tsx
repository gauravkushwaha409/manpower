...
const UpdateJobInterviewModal: React.FC<IProps> = ({ formik, handleCloseModal, isOpen }) => {
   return (
      <Dialog open={isOpen} onOpenChange={handleCloseModal}>
         <DialogContent className="max-h-[80vh] overflow-y-auto scroll-none sm:max-w-[80vw] lg:max-w-[70vw] [&>button:hover]:cursor-pointer">
            <DialogHeader>
               <DialogTitle>Update Job Interview</DialogTitle>
               <DialogDescription>
                  Fill the form to update Job Interview.
               </DialogDescription>
            </DialogHeader>
            <JobInterviewForm formik={formik} isUpdate />
         </DialogContent>
      </Dialog>
   )
}

export default UpdateJobInterviewModal