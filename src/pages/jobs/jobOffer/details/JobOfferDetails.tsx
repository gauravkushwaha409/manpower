      ...
      <div className='h-full w-full px-5 py-6 bg-surface rounded-lg'>
         ...
         <div className='flex items-center justify-start'>
            <div className='flex justify-start gap-4'>
               <img
                  ...
                  src={arrowBackIcon}
                  alt="" />
               <span className='typography-heading-poppins-medium text-Black-700'>Job Offer Details</span>
            </div>
         </div>
         ...
         <div className='mt-10 px-2 flex flex-col gap-2'>
            ...
            <div className='flex items-center gap-3.5'>
               ...
               <span className='typography-caption-c1 px-2.5 py-1 bg-yellow/30 rounded-lg'>Accepted</span>
            </div>
         ...
         <div className='mt-5'>
            <div className='px-6 pt-6 pb-12 mt-8 bg-white rounded-lg'>
               <p className='typography-p2-semibold text-text-color'>Basic Details For Job Offer</p>
               ...
               <div className='mt-6 w-full flex flex-col justify-center gap-5'>
                  ...
                  {/* Offer Date */}
                  <div className='flex items-center gap-8'>
                     <p className='w-1/4 typography-p2-regular text-Black-300'>Offer Date</p>
                     <p className='w-3/4 typography-p2-regular text-Black-300'>2024/01/01</p>
                  </div>
