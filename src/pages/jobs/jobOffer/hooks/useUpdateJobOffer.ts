...
import { JobOfferValidation } from "./useCreateJobOffer";

const useUpdateJobOffer = () => {
 const [updateJobOffer, { isError: isUpdateJobOfferError, isLoading: isUpdateJobOfferLoading, isSuccess: isUpdateJobOfferSuccess }] = useUpdateDataMutation();
 ...
 const updateJobOfferFormik = useFormik({
  initialValues,
