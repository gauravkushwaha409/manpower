...
const JobDetails: React.FC = () => {
  ...
  const addMoreVacancies = () => {
    ...
    formik.setFieldValue("job_vaccancies", [
      ...formik.values.job_vaccancies,
      newField,
    ]);
  };
          ...
          <div className="flex flex-col gap-5">
            <div className="grid grid-cols-2 gap-5">
              ...
              <InputText
                label="Male Worker"
                name="male_workers"
                placeholder="Enter the number of male worker"
              />
              <InputText
                label="Female Worker"
                name="female_workers"
                placeholder="Enter the number of female worker"
              />
              <InputSearchSelect
                label="Country"
                name="work_country"
              ...
              />
              <InputText
                label="Enter Contact Duration"
                name="contract_duration"
                placeholder="Enter Your Contact Duration"
              />
              <InputText
                label="Probation Period"
                name="probation_period"
                placeholder="Enter Your Probation Period"
              />
              <InputText
                label="Overtime"
                name="overtime"
              ...
              <InputText
                ...
                placeholder="Enter Food and Accomodation"
              />
              <InputText
                label="Medical Insurance"
                name="medical_insurance"
                placeholder="Enter Medical Issurance"
              />
              <InputText
                label="Annual Leave"
                name="annual_leave"
                placeholder="Enter Anual Leave"
              />
              <InputText
