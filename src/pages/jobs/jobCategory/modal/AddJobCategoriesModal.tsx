...
const AddJobCategoryModal: React.FC<IProps> = ({ formik, handleCloseModal, isOpen }) => {
   return (
      <Dialog open={isOpen} onOpenChange={handleCloseModal}>
         <DialogContent className="max-h-[80vh] overflow-y-auto scroll-none sm:max-w-[425px] lg:max-w-[70vw] [&>button:hover]:cursor-pointer">
            <DialogHeader>
               <DialogTitle>Add JobCategory</DialogTitle>
               <DialogDescription>
                  Fill the form to add a new JobCategory.
               </DialogDescription>
            </DialogHeader>
            <JobCategoryForm formik={formik} />
         </DialogContent>
      </Dialog>
   )
}
