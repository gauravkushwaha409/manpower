...
const useCreateCandidate = ({ step }: IProps) => {
 const [createCandidate, { isError: isCreateCandidateError, isLoading: isCreateCandidateLoading, isSuccess: isCreateCandidateSuccess }] = usePostDataMutation();
